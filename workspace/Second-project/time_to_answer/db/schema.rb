...
ActiveRecord::Schema.define(version: 2022_07_20_140704) do
  ...
  create_table "admin_statistic_infos", force: :cascade do |t|
    t.string "event"
  ...
  create_table "test_answers", force: :cascade do |t|
    ...
    t.index ["user_test_id"], name: "index_test_answers_on_user_test_id"
  end
  ...
  create_table "user_statistic_infos", force: :cascade do |t|
    t.integer "user_id"
